...
## :orange_circle: Общая информация о тестовом фреймворке
...
## :orange_circle: Технологии и инструменты
<p align="center">
...
## :orange_circle: Реализованные проверки
...
## :orange_circle: Запуск из терминала
Локальный запуск:
```bash
gradle clean test
