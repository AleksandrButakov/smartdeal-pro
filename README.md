...
## :information_source: Общая информация о тестовом фреймворке
...
## :information_source: Технологии и инструменты
<p align="center">
...
## :information_source: Реализованные проверки
...
## :information_source: Запуск из терминала
Локальный запуск:
```bash
gradle clean test
